...
class LangChainQueryGenerator_based_on_full_TREC_Context(BaseQueryGenerator):
    """
    ...
    def __init__(self, stopword_file, prompt_file, n=3,provider='ollama',model='mistral',temperature=1.0,verbose=False, background_file=[]):
        super(LangChainQueryGenerator_based_on_full_TREC_Context, self).__init__(stopword_file, background_file=background_file, allow_similar=False)
        prompt_template = ""
