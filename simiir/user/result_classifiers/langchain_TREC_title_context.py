...
class LangChainTextClassifier_based_on_TREC_Title(BaseTextClassifier):
    """
    ...
    def __init__(self, topic, user_context, prompt_file, result_type_str, provider = 'ollama', model = 'mistral', temperature = 0.0, verbose = False):
        ...
        """
        super(LangChainTextClassifier_based_on_TREC_Title, self).__init__(topic, user_context)
        self.updating = False
        prompt_template = ""
    ...
    def is_relevant(self, document):
        ...
        out = self._llm.generate_response(self._output_parser,{ 'topic_title': topic_title, 'doc_title': doc_title, 'doc_content': doc_content },self._result_schema)
